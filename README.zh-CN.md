# xl3 — 用模板生成 Excel 报表,而不是写代码

> 转换逻辑就写在 Excel 文件里,随时自己改;传入数据即可执行,格式原样保留,
...
表达式语言 · **`@xl3-lang/xl3`** = 它的 TypeScript 参考实现。
...
169 条 fixture 组成的 conformance 语料库、以及刻意保持精简的 XTL
表面所共同服务的目标。
...
- **Conformance 语料库。** 77 个 ADR 下共 169 条 fixture,全部通
